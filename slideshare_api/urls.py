...
urlpatterns = [
    ...
    path('download-compressed-pdf/', DownloadPDFView.as_view(), name='download_compressed_pdf'),
    path('download-compressed-ppt/', DownloadPPTView.as_view(), name='download_compressed_ppt'),
    path('download-compressed-word/', DownloadWordView.as_view(), name='download_compressed_word'),
]